...
public class ImmortalSnail implements DedicatedServerModInitializer {
    ...
    public void onInitializeServer() {
        ...
        PayloadTypeRegistry.serverboundPlay().register(BargainOpenPayload.TYPE, BargainOpenPayload.CODEC);
        ...
        ServerPlayNetworking.registerGlobalReceiver(BargainSubmitPayload.TYPE, (payload, context) -> {
            ...
            player.level().getServer().execute(() -> {
                PlayerFirstJoinHandler.onBargainSubmitted(player.level().getServer(), player, a, b);
            });
        });
