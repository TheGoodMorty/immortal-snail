 ...
 * We don't compile against JEI because its 26.2 build isn't on Maven Central
...
public final class JeiIntegration {
     ...
     */
    public static void openItemPicker(Minecraft client) {
        if (client.player != null) {
            client.player.sendSystemMessage(Component.literal(
                    "JEI is loaded. Use the JEI item list overlay (right side of screen) to find items, then drag/click to place them in the bargain shulkers."));
        }
    }
}
