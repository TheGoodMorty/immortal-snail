...
A server-side Fabric mod for **Minecraft Java 26.2** (Mojang official mappings) that turns every non-operator player into the subject of the Immortal Snail thought experiment.
...
|---|---|---|
| Minecraft | `26.2` (released 2026-04-07) | Unobfuscated — Mojang official mappings only. |
| Mappings | Mojang official | No Yarn; 26.1+ dropped Yarn entirely. |
| Fabric Loader | `0.19.x` | Latest stable. |
| Fabric API | `0.158.0+26.2` | Required. |
| Cloth Config | `26.2.155` | Required (TOML config). |
| JEI | `30.24.0.176` (26.2) | Soft dependency. |
| Java | 25 | Required by Minecraft 26.1+. |
| Build tool | Gradle 9.x via Fabric Loom 1.17.20 (`net.fabricmc.fabric-loom`) | Standard. |
...
| Mace (26.2) | Mace | Density V, Breach IV, Wind Burst III (where available) |
| Misc | Gold Blocks | — (64) |
...
- **Mace enchantments on 26.2:** `Density V, Breach IV, Wind Burst III` are the max-level enchantments on the Mace. If Mojang has changed the cap, we'll adjust at build time.
